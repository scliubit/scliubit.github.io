...
从那次比赛之后，我们全线转向了Transformer结构的模型，其速度快效果好，而且论文里鲜有出现。这里没人看我就随便讲讲，一个博后很擅长灌这种水，而且写的好像真的有那回事一样。实际上就是几个DNN一连起来直接跑。那次审稿是借用了GNN的原理做的，但是从我个人的角度来看很水的JSAC。审稿的时候没人提出负面看法，基本是高分通过了。
