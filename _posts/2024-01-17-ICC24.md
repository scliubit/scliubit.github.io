...
今日我们的一篇基于离散长球变换的近场信道估计的论文被Flagship会议ICC'24正会的Wireless Communications Symposium接收，pre-print目前可以在[arXiv](https://arxiv.org/abs/2310.18180)上阅读。本文简单介绍提出方案的思路，并对部分审稿人意见予以解答。
...
<div>
    ...
    <div class="caption">DPSS字典设计流程</div>
</div>
...
<div>
    ...
    <div class="caption">码本稀疏化效果与正交性</div>
</div>
...
<div>
    ...
    <div class="caption">不同采样数与码本冗余倍数下的性能对比</div>
</div>
...
<div>
    ...
    <div class="caption">不同距离下的估计误差收敛性</div>
</div>
...
<div>
    ...
    <div class="caption">达到目标性能所需码本大小</div>
</div>

最后表格比较了一下如果想要达到指定性能，需要多大的码本。
