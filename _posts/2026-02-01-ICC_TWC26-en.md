...
The conference version has just been accepted, and the final version will take some time to publish. Since the [journal version](https://arxiv.org/abs/2512.21660) has already been submitted for review, we will not upload a conference arXiv preprint. The published version is now available [here](https://ieeexplore.ieee.org/document/11588130).
...
```plaintext
S. Liu, X. Yu, S. Song, and K. B. Letaief, ``Near-Field Communication with Movable Antennas: An Electrostatic Equilibrium Perspective'', IEEE Trans. Wireless Commun., 2026.
```
...
[^J3]: S. Liu, X. Yu, S. Song, and K. B. Letaief, "Near-Field Communication with Movable Antennas: An Electrostatic Equilibrium Perspective", Submitted to <i>IEEE Trans. Wireless Commun.</i>, Dec. 2025. [arXiv:2512.21660](https://arxiv.org/abs/2512.21660)
