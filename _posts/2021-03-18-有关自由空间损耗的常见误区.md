...
$$
\begin{align}
P_r/P_t=A_rA_t/d^2\lambda^2\tag{1},
\label{eq}
\end{align}
$$
...
![](https://raw.githubusercontent.com/scliubit/scliubit.github.io/main/img/Friis/sysModel.png)
...
$$
\begin{align}
A_{\rm dip.}=P_r/P_0=3\lambda^2/8\pi.\tag{10}
\end{align}
$$
