...
let getStoredStyle = () => {
  try {
    return normalizeStyle(localStorage.getItem("style"));
  } catch (e) {
    return "default";
  }
};
...
let setStyle = (style) => {
  ...
  try { localStorage.setItem("style", selectedStyle); } catch (e) {}
...
$(document).ready(function () {
  ...
  // Init smooth scroll for in-page anchor links only, excluding masthead nav links.
  // This avoids the flash/refresh effect when clicking navigation items that lead to other pages.
  $("a[href^='#']").not(".masthead a, .greedy-nav a").smoothScroll({
